...
inline fun <reified T> ByteArray.toInstance(
    offset: Int,
    len: Int
): T = Yaml.objectMapper.readValue(this, offset, len, T::class.java)
...
fun ByteArray.toJsonNode(
    offset: Int,
    length: Int
): JsonNode = Yaml.objectMapper.readTree(this, offset, length)
...
fun ByteArray.toJsonParser(
    offset: Int,
    length: Int
): JsonParser = Yaml.objectMapper.createParser(this, offset, length)
